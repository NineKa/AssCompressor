...
std::string ColorIO_Return_Front_Color(ColorIO_Color Front_Color){
    switch (Front_Color) {
        case Black:
...
std::string ColorIO_Return_Back_Color(ColorIO_Color Back_Color){
    switch (Back_Color) {
        case Black:
...
std::string ColorIO_Return_Style(ColorIO_Style Style){
    switch (Style) {
        case None:
...
std::string colorize(std::string content,
                     ColorIO_Color Front_Color,
                     ColorIO_Color Back_Color,ColorIO_Style Style){
    return "\e["+ColorIO_Return_Front_Color(Front_Color)+";"+
           ColorIO_Return_Back_Color(Back_Color)+";"+
           ColorIO_Return_Style(Style)+"m"+content+_Clear;
}

std::string colorize(std::string content,
                     ColorIO_Color Front_Color,
                     ColorIO_Color Back_Color){
    return "\e["+ColorIO_Return_Front_Color(Front_Color)+";"+
           ColorIO_Return_Back_Color(Back_Color)+"m"+content+_Clear;
}

std::string colorize(std::string content,ColorIO_Color Front_Color){
...
std::string colorize(std::string content, ColorIO_Style Style){
    return "\e["+
    ColorIO_Return_Style(Style)+"m"+content+_Clear;
}
